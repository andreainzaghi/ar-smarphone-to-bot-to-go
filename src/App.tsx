...
export default function App() {
  ...
  Per un servizio ottimale, ti preghiamo di <strong className="text-red-500"> mantenere l'app sempre aperta durante il servizio</strong>. L'app è il tuo cameriere personale e gestirà:
  <ul className="list-disc ml-4 mt-3 space-y-2 text-left">
